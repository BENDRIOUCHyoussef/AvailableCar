...
<body>
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"])) {
            ...
            if (count($errors) > 0) {
                ...
                // Changed SQL query to use prepared statement
                $sql = "INSERT INTO driver (First_name, Last_name, Phone, Postcode, Email, Password) VALUES (?, ?, ?, ?, ?, ?)";
                $stmt = mysqli_stmt_init($conn);
                ...
                if (mysqli_stmt_prepare($stmt, $sql)) {
                    ...
                    echo "<div class='alert alert-success'>You are registered successfully. <a href='LoginDriver.php'>Login</a></div>";
                } else {
                    die("Something went wrong");
                }
            }
    ...
    ?>
        <form class="form-signin" method="post" >
            ...
            <!-- Submit button -->
            <button type="submit" name = "submit" class="btn btn-primary btn-block mb-12">Sign Up</button>

            <!-- Register buttons -->
            <div class="text-center">
                <p>Already have an Account? <a href="LoginDriver.html">Login</a></p>
            </div>
        </form>
    </div>
